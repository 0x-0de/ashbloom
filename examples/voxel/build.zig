...
fn add_libraries(b: *std.Build, ashbloom: *std.Build.Dependency, cmp: *std.Build.Step.Compile, target: std.Build.ResolvedTarget, optimize: std.builtin.OptimizeMode) void
{
...
pub fn build(b: *std.Build) void
{
    ...
    add_libraries(b, ashbloom, exe, std_target, std_optimize);
    ...
    add_library_dependencies(b, &install_exe_test.step, ashbloom);

    add_libraries(b, ashbloom, exe_test, std_target, std_optimize);
