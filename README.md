...
I'm still working on the initial release for Ashbloom! Check out the ```dev``` branch for the latest version!

# What is this?

Ashbloom is my own little framework which provides some bootstrapping for Vulkan in Zig. It will eventually grow to encompass several aspects of game and graphical application development, but for now here's the checklist for the initial release:
...
- Linear algebra library **[done, needs testing]**
- Vulkan memory allocator **[done, needs testing]**
- Vulkan texture loader (.bmps only) **[done, needs testing]**
